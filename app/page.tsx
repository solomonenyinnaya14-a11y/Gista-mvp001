...
export default function HomePage(){
 ...
 const loadPosts=useCallback(async(currentUser:{id:string}|null)=>{
  ...
  if(postsResult.error){setFeedError(postsResult.error.message);setLoading(false);return}
  if(followsResult.error){setFeedError(followsResult.error.message);setLoading(false);return}
  ...
  if(profileResult.error){setFeedError(profileResult.error.message);setLoading(false);return}
  if(engagementResult.error){setFeedError(engagementResult.error.message);setLoading(false);return}
